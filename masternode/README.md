...
3. Build docker images for master node and deploy dags. Images will be built and dags required files (under dags folder) will be copied to <shared_drive>/dags
```
